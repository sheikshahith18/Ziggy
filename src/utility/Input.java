...
public class Input {
	...
	private static boolean isNewLinePresent = false;
	private static int attempt = 1;

	public static boolean isAttemptExceeded(int attempts) {
		if (attempts > 3) {
			attempt = 1;
	...
	public static int getInteger(boolean limit) {
		...
		if (limit && isAttemptExceeded(attempt++))
			return -1;
