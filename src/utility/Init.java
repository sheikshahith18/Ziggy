...
public class Init {
	...
	public static void initializeHotel() {
		...
		Hotel h1 = new Hotel("Hotel MSS", "Sheik", "madurai", 625020, "9876543210", "hotel@gmail.com", false,
				"Qwerty@123");
	...
	public static void initializeCustomer() {
		...
		cDB.addCustomer(
				new Customer("customer1", "9876543210", "customer1@gmail.com", "madurai", 625020, "Qwerty@123"));
		cDB.addCustomer(
				new Customer("customer2", "9012345678", "customer2@gmail.com", "madurai", 625020, "Qwerty@123"));
