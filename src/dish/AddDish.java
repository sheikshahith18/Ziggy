...
public class AddDish {
	...
	public Pizza addPizza() {
		addDish(false);
		System.out.print("\nDo you want to add toppings (press 1 for yes else skip) :");
		toppings.clear();
	...
	public Chicken addChicken() {
		addDish(false);
		System.out.print("\nDo you want to add sidedish (press 1 for yes else skip) : ");
		extras.clear();
		int option = Input.getInteger(false);
		if (option == 1) {
			do {
				...
				System.out.print("Press 1 to add more or 2 to exit : ");
				option = Input.getInteger(1, 2, false);
			} while (option == 1);
	...
	public void updatePizza(Hotel h, int dishId) {
		...
		do {
			...
			case 4: {
				...
				System.out.println("\n\u001b[32m" + "Toppings Added Successfully" + "\u001b[0m");
	...
	public void updateDrinks(Hotel h, int dishId) {
		...
		do {
			...
			case 4: {
				...
				System.out.println("\n\u001b[32m" + "Temperature Changed Successfully" + "\u001b[0m");
				break;
			}
			case 5: {
				boolean removeDish = removeDish();
